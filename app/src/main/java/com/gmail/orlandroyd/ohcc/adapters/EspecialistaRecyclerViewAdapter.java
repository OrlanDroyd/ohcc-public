 ...
 */
public class EspecialistaRecyclerViewAdapter extends RecyclerView.Adapter<EspecialistaRecyclerViewAdapter.EspecialistaViewHolder> {
    private List<Usuario> itemList;
    private Context context;
    private OnItemClicklistener listener;

    public EspecialistaRecyclerViewAdapter(List<Usuario> itemList, Context context) {
    ...
    @NonNull
    @Override
    public EspecialistaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_especialista, null);
        EspecialistaViewHolder rcv = new EspecialistaViewHolder(layoutView, context);
        return rcv;
    }
    ...
    class EspecialistaViewHolder extends RecyclerView.ViewHolder {
        public AppCompatTextView tvFullName;
        public AppCompatTextView tvNombreUsuario;
        public Context context;

        public EspecialistaViewHolder(@NonNull View itemView, Context context) {
            super(itemView);
